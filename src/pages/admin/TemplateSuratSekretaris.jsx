          ...
          <div>
            ...
            <div className="h-screen w-1/4 ml-4 border-r-4 border-black container mx-auto">
              ...
              <nav className="mt-10 px-6 ">
                ...
                <a
                  className="hover:text-gray-800 hover:bg-gray-100 flex items-center p-2 my-6 transition-colors dark:hover:text-white dark:hover:bg-gray-600 duration-200  text-gray-800 dark:text-gray-400 rounded-lg dark:text-gray-100 rounded-lg dark:bg-gray-600 "
                  href="SuratSek">
