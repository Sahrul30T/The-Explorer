    ...
    <div>
      <div className="flex justify-center items-center flex-wrap">
        ...
        <div className="w-[1455.398px] h-[62px] flex-col justify-start items-center inline-flex">
          <div className="w-[308px] h-[26px] text-center text-blue-900 text-4xl font-extrabold font-['Inter'] leading-10">
            Media Kampus
          </div>
          ...
          <div className="w-[418.70px] text-center text-black text-base font-normal font-['Inter'] leading-normal">
          ...
          <div className="w-[1106px] h-[413px] pr-12 bg-neutral-800 bg-opacity-80 rounded-lg shadow border border-slate-200 justify-between items-center inline-flex">
            ...
            <div className="flex-col justify-center items-start inline-flex">
              <div className="w-[488px] justify-start items-center gap-3.5 inline-flex">
                <div className="text-right text-white text-sm font-normal font-['Inter'] leading-tight">
                  Rabu 15, Nov 2023
                </div>
              </div>
              <div className="w-6 h-6 relative opacity-0">
              ...
              <div className="w-[495px] text-white text-3xl font-extrabold font-['Inter'] uppercase leading-10">
              ...
              <div className="w-[488px] text-white text-base font-normal font-['Inter'] leading-normal">
              ...
              <div className="self-stretch justify-start items-center gap-2 inline-flex">
                ...
                <div className="text-right text-white text-sm font-semibold font-['Inter'] leading-tight">
