          ...
          <div className="relative flex flex-col min-w-0 break-words bg-light-white w-full mb-8 shadow-lg rounded-lg">
            <div className="px-4 py-8 flex-auto">
              ...
              <p className="mt-2 mb-4 text-blueGray-500">
                2. MENGOPTIMALKAN SETIAP FUNGSI DARI SETIAP DIVISI HMPS SI STT
                NF
              </p>
              <p className="mt-2 mb-4 text-blueGray-500">
                3. MENJADIKAN MAHASISWA PRODI SI YANG BERKARAKTER CERDIK
                (CERMAT, ENERGIK, RELIGIUS, DISIPLIN, INOVATIF, KOMPETEN) DI
                BIDANG AKADEMIK MAUPUN NON-AKADEMIK.
              </p>
              <p className="mt-2 mb-4 text-blueGray-500">
                4. MENJADI WADAH KEGIATAN MINAT BAKAT, PENYALUR ASPIRASI, SERTA
                TEMPAT BERTUKAR PIKIRAN MAHASISWA PRODI SI STT NF.
              </p>
              <p className="mt-2 mb-4 text-blueGray-500">
                5. MENJALIN KERJA SAMA DENGAN PIHAK INTERNAL DAN EKSTERNAL
