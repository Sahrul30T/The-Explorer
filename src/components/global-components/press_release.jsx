...
function press_release() {
  return (
    <div className="container mx-auto pt-11">
      <div>
        <div className="self-stretch text-center text-blue-900 text-5xl font-extrabold leading-[48px]">
          Press Release
        </div>
        ...
        <div className="self-stretch text-center text-black text-lg pb-8 font-semibold  leading-normal">
          Berita acara terbaru HMPS-SI
        </div>
      </div>
      <div className="justify-center items-center pl-24 gap-9 inline-flex">
        <img className="" src={Img} />
        <div className=" relative flex-col justify-start items-start flex">
          <div className="w-[500px] text-black text-3xl font-medium leading-7">
          ...
          <div className="px-[18px] py-[11px] bg-blue-900 rounded-md shadow justify-center items-center gap-[3px] inline-flex">
